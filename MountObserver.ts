...
export class MountObserver extends EventTarget implements IMountObserver {
    ...
    async #emitMountedElementEvents(element: Element): Promise<void> {
    ...
    async #emitSingleEvent(element: Element, config: EventConfig): Promise<void> {
    ...
    #resolveEventConstructor(event: string | EventConstructor): EventConstructor {
    ...
    #getEventId(config: EventConfig): string {
    ...
    #processMagicStrings(value: any, element: Element): any {
